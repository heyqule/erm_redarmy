  ...
  data_type = ERM_REDARMY.MOD_NAME..'.boss_reward_data',
            data = {
                reward_data = {
                    ...
                    --- record with minimum chest appearance MUST roll first, spawn_chance should be low to prevent too many duplicates
                    --- record with low spawn chance should roll first after the one with minimum_chest_appearance
                    {"agricultural-science-pack", 10, 2},
                    {"cryogenic-science-pack", 15, 0},
                    {"metallurgic-science-pack", 25, 0},
                    {"electromagnetic-science-pack", 25, 0},
                    {"utility-science-pack", 40, 0},
