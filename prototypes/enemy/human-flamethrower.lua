    ...
    data:extend({
        {
            ...
            attack_parameters = {
                ...
                damage_modifier = ERM_UnitHelper.get_damage(base_physical_damage, incremental_physical_damage, level) / 4,
                ...
                ammo_type =
                {
                    action =
                    {
                        ...
                        {
                            type = "stream",
                            stream = ERM_REDARMY.MOD_NAME..'--flamethrower-fire-stream',
                            source_offset = {0, -5}
                        }
                    }
                },
