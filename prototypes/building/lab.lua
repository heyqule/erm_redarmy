...
local spawn_table = function(level)
    local res = {}
    --Tire 1
    res[1] = { MOD_NAME .. '/human-miner/' .. level, { { 0.0, 1 }, { 0.2, 0.75 }, { 0.4, 0.4 }, { 0.6, 0.4 }, { 0.8, 0.0 }, { 1.0, 0.0 } } }
    res[2] = { MOD_NAME .. '/human-pistol/' .. level, { { 0.0, 0 }, { 0.2, 0.25 }, { 0.4, 0.4 }, { 0.6, 0.2 }, { 0.8, 0.0 }, { 1.0, 0.0 } } }
    --Tire 2
    res[3] = { MOD_NAME .. '/human-machinegun/' .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.1 }, { 0.6, 0.3 }, { 0.8, 0.5 }, { 1.0, 0.1 } } }
