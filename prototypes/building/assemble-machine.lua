...
local spawn_table = function(level)
    ...
    res[5] = { MOD_NAME .. '/tank-cannon/' .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.0 }, { 0.8, 0.0 }, { 1.0, 0.0 } } }
    --Tire 3
    ...
    res[8] = { MOD_NAME .. '/tank-explosive-cannon/' .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.0 }, { 0.8, 0.0 }, { 1.0, 0.0 } } }
    res[9] = { MOD_NAME .. '/plane-gunner/' .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.0 }, { 0.8, 0.0 }, { 1.0, 0.2 } } }
