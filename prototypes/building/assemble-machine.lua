...
local spawn_table = function(level)
    local res = {}
    --Tire 1
    res[1] = { ERM_REDARMY.MOD_NAME .. '--human-miner--' .. level, { { 0.0, 1 }, { 0.2, 0.7 }, { 0.4, 0.5 }, { 0.6, 0.4 }, { 0.8, 0.3 }, { 1.0, 0.1 } } }
    res[2] = { ERM_REDARMY.MOD_NAME .. '--human-pistol--' .. level, { { 0.0, 0 }, { 0.2, 0.25 }, { 0.4, 0.35 }, { 0.6, 0.2 }, { 0.8, 0.0 }, { 1.0, 0.0 } } }
    --Tire 2
    res[3] = { ERM_REDARMY.MOD_NAME .. '--human-machinegun--' .. level, { { 0.0, 0.0 }, { 0.2, 0.05 }, { 0.4, 0.1 }, { 0.6, 0.3 }, { 0.8, 0.2 }, { 1.0, 0.1 } } }
    res[4] = { ERM_REDARMY.MOD_NAME .. '--human-sniper--' .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.05 }, { 0.6, 0.1 }, { 0.8, 0.1 }, { 1.0, 0.1 } } }
    res[5] = { ERM_REDARMY.MOD_NAME .. '--tank-cannon--' .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.0 }, { 0.8, 0.05 }, { 1.0, 0.05 } } }
    res[6] = { ERM_REDARMY.MOD_NAME .. '--plane-gunner--' .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.0 }, { 0.8, 0.05 }, { 1.0, 0.2 } } }
    --Tire 3
    res[7] = { ERM_REDARMY.MOD_NAME .. '--human-engineer--' .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.0 }, { 0.8, 0.05 }, { 1.0, 0.05 } } }
    res[8] = { ERM_REDARMY.MOD_NAME .. '--human-flamethrower--' .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.0 }, { 0.8, 0.1 }, { 1.0, 0.1 } } }
    res[9] = { ERM_REDARMY.MOD_NAME .. '--human-shotgun--' .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.0 }, { 0.8, 0.1 }, { 1.0, 0.1 } } }
    res[10] = { ERM_REDARMY.MOD_NAME .. '--tank-explosive-cannon--' .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.0 }, { 0.8, 0.0 }, { 1.0, 0.05 } } }
    res[11] = { ERM_REDARMY.MOD_NAME .. '--plane-bomber--' .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.0 }, { 0.8, 0.05 }, { 1.0, 0.1 } } }
    res[12] = { ERM_REDARMY.MOD_NAME .. '--plane-dropship--' .. level, { { 0.0, 0.0 }, { 0.2, 0.0 }, { 0.4, 0.0 }, { 0.6, 0.0 }, { 0.8, 0.0 }, { 1.0, 0.05 } } }
    return res
end
