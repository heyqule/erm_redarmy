...
data:extend{
    ...
    },
    {
        ...
        name = "erm_redarmy_base_intensity",
    ...
    {
        type = "noise-expression",
        name = "erm_redarmy_base_probability",
        expression = "spot_noise{x = x,\z
                             y = y,\z
                             density_expression = spot_quantity_expression * max(0, erm_redarmy_base_frequency),\z
        ...
        local_expressions =
        {
            spot_radius_expression = "max(0, erm_redarmy_base_radius)",
    ...
    {
        type = "noise-function",
        name = "erm_redarmy_autoplace_base",
        parameters = {"distance_factor", "seed"},
        expression = "random_penalty{x = x + seed,\z
                                 y = y,\z
                                 source = min(erm_redarmy_base_probability * max(0, 1 + 0.002 * distance_factor * (-312 * distance_factor - starting_area_radius + distance)),\z
